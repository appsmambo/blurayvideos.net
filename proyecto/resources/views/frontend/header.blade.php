<div class="contact-cart">
	<div class="container">
		<div class="items d-flex align-items-center">
			<div class="p-2"><a href="mailto:contacto@blurayvideos.net"><i class="fas fa-envelope"></i> contacto@blurayvideos.net</a></div>
			<div class="p-2"><a href="mailto:contacto@blurayvideos.net"><i class="fas fa-phone"></i> +51 915975984</a></div>
			<div class="ml-auto p-2"><a href="#">CARRITO DE COMPRA <i class="fas fa-shopping-cart"></i></a></div>
		</div>
	</div>
</div>
...
<h2 class="text-center mt-4">
	...
	<br>
	<small>NUEVOS TITULOS EN NUESTRA WEB</small>
</h2>
<div class="container">
